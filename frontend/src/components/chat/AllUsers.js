 ...
 * AllUsers Component
 * 
 * This component displays a list of users and chat rooms. It manages creating new chat rooms and 
 * selecting existing ones. It also categorizes users into contacts (those with existing chat rooms) 
 * and non-contacts.
 */
...
export default function AllUsers({
  ...
  // Extract contact IDs from chat rooms
  useEffect(() => {
  ...
  // Filter users to find non-contacts
  useEffect(() => {
    setNonContacts(
      users.filter(
