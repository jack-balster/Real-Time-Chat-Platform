 ...
 * ChatForm Component
 * 
 * This component renders the input form for sending messages in a chat.
 * It includes an emoji picker and a text input for the message.
 * It also handles submitting the message.
 */
...
export default function ChatForm(props) {
  ...
  const scrollRef = useRef(); // Reference to handle scrolling

  // Scroll to the bottom when emoji picker is toggled
  useEffect(() => {
